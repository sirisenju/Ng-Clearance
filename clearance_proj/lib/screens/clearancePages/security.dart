...
class SecurityClearance extends StatefulWidget {
  const SecurityClearance({super.key});

  @override
  State<SecurityClearance> createState() => _SecurityClearanceState();
}

class _SecurityClearanceState extends State<SecurityClearance> {
  ...
  Future uploadFiles(String userUid, File documentFile, String filename) async {
    ...
    await FirebaseFirestore.instance.collection('user_documents')
        .doc(userUid)
        .collection('documents').doc("security_clearance").set({
      'filename': filename,
      'url': downloadURL,
          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Text("Welcome to your Security Clearance Guide.",
