...
class LibraryClearance extends StatefulWidget {
  const LibraryClearance({super.key});

  @override
  State<LibraryClearance> createState() => _LibraryClearanceState();
}

class _LibraryClearanceState extends State<LibraryClearance> {
  ...
  Future uploadFiles(String userUid, File documentFile, String filename) async {
    ...
    await FirebaseFirestore.instance.collection('user_documents')
        .doc(userUid)
        .collection('documents').doc("library_clearance").set({
      'filename': filename,
      'url': downloadURL,
          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Text("Welcome to your Library Clearance Guide.", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500)
                ),
              ),
              const Padding(
                padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 8.0),
