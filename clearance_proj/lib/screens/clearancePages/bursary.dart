...
class _BursaryClearanceState extends State<BursaryClearance> {
  ...
  List<String> clearanceItems = [
    "All Stamped SUG receipt from 100lv to final year",
    "All Stamped School Fees receipt from 100lv to final year",
    "All Stamped NASS Dues receipt from 100lv to final year",
  ];
          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Text("Welcome to your Bursary Clearance Guide.", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500)),
              ),
              const Padding(
                padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 8.0),
                child: Text(
