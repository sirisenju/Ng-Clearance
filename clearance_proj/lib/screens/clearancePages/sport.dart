...
class SportClearance extends StatefulWidget {
  const SportClearance({super.key});

  @override
  State<SportClearance> createState() => _SportClearanceState();
}

class _SportClearanceState extends State<SportClearance> {
  ...
  Future uploadFiles(String userUid, File documentFile, String filename) async {
    ...
    await FirebaseFirestore.instance.collection('user_documents')
        .doc(userUid)
        .collection('documents').doc("sport_clearance").set({
      'filename': filename,
      'url': downloadURL,
          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Text("Welcome to your Sport Clearance Guide.",
