...
class AcademicClearance extends StatefulWidget {
  const AcademicClearance({super.key});

  @override
  State<AcademicClearance> createState() => _AcademicClearanceState();
}

class _AcademicClearanceState extends State<AcademicClearance> {
  ...
  Future uploadFiles(String userUid, File documentFile, String filename) async {
    ...
    await FirebaseFirestore.instance.collection('user_documents')
        .doc(userUid)
        .collection('documents').doc("academic_clearance").set({
      'filename': filename,
      'url': downloadURL,
          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Text("Welcome to your Academic Clearance Guide.",
